      ...
      if (user != null) {
        if (!user.emailVerified) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text(
                "Please verify your email first. Verification email resent!",
              ),
        ...
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text("Welcome, $adminName!")));
...
// === AdminRegisterPage and AdminForgotPasswordPage remain unchanged ===
...
class _AdminRegisterPageState extends State<AdminRegisterPage> {
  ...
  Future<String> _generateAdminId() async {
    ...
    if (snapshot.docs.isNotEmpty &&
        snapshot.docs.first.data().containsKey('admin_id')) {
    ...
    try {
      ...
      if (user != null) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              "Registration successful! Verification email sent. Your ID is $adminId",
            ),
          ),
        );
